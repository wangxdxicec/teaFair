...
public class TTeaVisitorInfo implements java.io.Serializable {
    private Integer id;
    ...
    /** default constructor */
    public TTeaVisitorInfo() {
    }

    /** minimal constructor */
    public TTeaVisitorInfo(Integer id) {
        this.id = id;
    }

    public TTeaVisitorInfo(String address, String backupEmail, String beenToFair, String beenToRole, String checkingNo,
                           String city, String company, Integer country, String createIp,
                           Date createTime, Integer customer_type, String email, String fax, String faxCode2,
                           String faxCode, String firstName, Integer govementFlag, String guid, Integer id,
                           String industry, String industryOther, Boolean isAccommodation, Boolean isDisabled,
                           Boolean isjudged, Boolean isMobile, Integer isProfessional, Boolean isReaded,
                           Boolean isRecieveDoc, Boolean isRecieveEmail, String langFlag, String lastName,
                           String mobileCode, String mobilePhone, String password, String position,
                           String province, String rabbi, String remark, Integer sendEmailNum, Date sendEmailTime,
                           Integer sendMsgNum, Date sendMsgTime, String sex, String tel, String telCode2, String telCode,
                           String tmp_Country, String tmp_Interest, String tmp_InterestOthers, String tmp_Knowfrom,
                           String tmp_KnowfromOthers, String tmp_Postcode, String tmp_V_contact1, String tmp_V_contact2,
                           String tmp_V_contact3, String tmp_V_name1, String tmp_V_name2, String tmp_V_name3,
                           String tmp_V_position1, String tmp_V_position2, String tmp_V_position3, String tmp_V_title1,
                           String tmp_V_title2, String tmp_V_title3, String updateIp, Date updateTime, String visitDate,
                           String website) {
