 ...
 */
@Entity
@Table(name = "visitor_Apply_Mail", schema = "dbo")
public class VApplyEmail implements java.io.Serializable {
	...
	/** minimal constructor */
	public VApplyEmail(Integer id) {
		this.id = id;
	}

	public VApplyEmail(Integer customerID, Date createTime, String createIP, Date confirmTime, String confirmIP,
