...
public class TeaExhibitor implements java.io.Serializable {
	...
	/** minimal constructor */
	public TeaExhibitor(Integer eid) {
		this.eid = eid;
	}
	 ...
	 * full constructor
	 */
	public TeaExhibitor(Integer eid, String username, String password, Integer level, Integer area, Date lastLoginTime,
						...
						Integer group, String contractId, String exhibitionArea, String exhibitor_type,
						Integer isLogin, String fair_year) {
		this.eid = eid;
	...
	public TeaExhibitor(Integer eid, String username, String password, Integer level,
