...
<table id="treeGrid" class="easyui-treegrid"
    ...
    <tr>
        ...
        <th field="iconCls" width="100" align="center" formatter="formatIconCls" >图标</th>
...
<div id="tb">
    <div>
        <privilege:operation operationId="10000" clazz="easyui-linkbutton" onClick="openMenuAddDialog()" name="添加"
                             iconCls="icon-add"></privilege:operation>
        <privilege:operation operationId="10001" clazz="easyui-linkbutton" onClick="openMenuUpdateDialog()" name="修改"
                             iconCls="icon-edit"></privilege:operation>
        <privilege:operation operationId="10002" clazz="easyui-linkbutton" onClick="deleteMenu()" name="删除"
                             iconCls="icon-remove"></privilege:operation>
        <privilege:operation operationId="10014" clazz="easyui-linkbutton" onClick="openOperationDialog()" name="按钮管理"
                             iconCls="icon-edit"></privilege:operation>
    </div>
</div>
    ...
    <form id="fm" method="post">
        <table cellspacing="5px;">
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>序号：</td>
                <td><input type="text" id="seq" name="seq" class="easyui-validatebox" required="true"
...
<div id="iconDiv" class="easyui-dialog" style="width: 450px;height: 300px;padding: 10px 20px" closed="true">
    <div>
        <c:forEach begin="1" end="520" step="1" varStatus="s">
            <div onclick="subIcon('icon-${s.index }');" class="easyui-linkbutton" style="float:left;margin-left:15px;"
                 iconCls="icon-${s.index }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
...
<div id="operationTb">
    <div>
        ...
        <a href="javascript:openOperationUpdateDialog()" class="easyui-linkbutton" iconCls="icon-edit"
           plain="true">修改</a>
...
<div id="operationReserveDlg" class="easyui-dialog" style="width: 350px;height: 200px;padding: 10px 20px"
    ...
    <form id="fm2" method="post">
        <table cellspacing="5px;">
            <tr>
                <td>所属菜单：</td>
                <td><input type="text" id="o_menuName" name="menuName" class="easyui-validatebox" readonly="readonly"/>
                </td>
            </tr>
            <tr>
                <td>按钮名称：</td>
                <td><input type="text" id="operationName" name="operationName" class="easyui-validatebox"
                           required="true"/></td>
            </tr>
