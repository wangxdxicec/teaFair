...
<!-- 展示列表 -->
<table id="dg" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true" url="roleList.htm" fit="true" toolbar="#tb">
    <thead>
    <tr>
...
<div id="tb">
    ...
    <div>
        <privilege:operation operationId="10006" clazz="easyui-linkbutton" onClick="openRoleAddDialog()" name="添加"
                             iconCls="icon-add"></privilege:operation>
        <privilege:operation operationId="10007" clazz="easyui-linkbutton" onClick="openRoleUpdateDialog()" name="修改"
                             iconCls="icon-edit"></privilege:operation>
        <privilege:operation operationId="10008" clazz="easyui-linkbutton" onClick="deleteRole()" name="删除"
                             iconCls="icon-remove"></privilege:operation>
        <privilege:operation operationId="10009" clazz="easyui-linkbutton" onClick="openMenuDialog()" name="授权"
                             iconCls="icon-edit"></privilege:operation>
    </div>
    <div class="updownInterval"></div>
    <div>
...
<div id="dlg" class="easyui-dialog" style="width: 570px;height: 350px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="5px;">
            <tr>
                <td>角色名称：</td>
                <td width="80%"><input type="text" id="roleName" name="roleName" class="easyui-validatebox"
                                       required="true"/></td>
            </tr>
            <tr>
                <td valign="top">备注：</td>
