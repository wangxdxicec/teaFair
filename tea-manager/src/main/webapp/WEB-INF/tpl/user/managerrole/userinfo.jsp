...
<head>
    ...
    <script type="text/javascript">
        ...
        function openUserUpdateDialog() {
            ...
            url = "reserveUser.htm?userId=" + row.id;
        }
        ...
        $(function () {
            ...
            $("#s_roleId").combobox({
                url: '${path }/user/roleCombobox.htm',
                method: 'post',
                valueField: 'roleId',
                textField: 'roleName',
                editable: false,
...
<div id="tb">
    ...
    <div>
        <privilege:operation operationId="10003" clazz="easyui-linkbutton" onClick="openUserAddDialog()" name="添加"
                             iconCls="icon-add"></privilege:operation>
        <privilege:operation operationId="10004" clazz="easyui-linkbutton" onClick="openUserUpdateDialog()" name="修改"
                             iconCls="icon-edit"></privilege:operation>
        <privilege:operation operationId="10005" clazz="easyui-linkbutton" onClick="deleteUser()()" name="删除"
                             iconCls="icon-remove"></privilege:operation>
    </div>
    <div class="updownInterval"></div>
    <div>
        &nbsp;用户名：&nbsp;<input type="text" name="s_userName" id="s_userName" size="20"
...
<div id="dlg" class="easyui-dialog" style="text-align:right;width: 820px;height: 320px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="5px;">
            ...
            <tr>
                <td>角色：</td>
                <td><input type="hidden" id="roleId" name="roleId"/><input type="text" id="roleName" name="roleName"
                                                                           readonly="readonly"
...
<div id="dlg2" class="easyui-dialog" iconCls="icon-search" style="width: 500px;height: 480px;padding: 10px 20px"
    ...
    <div style="height: 350px;">
        <table id="dg2" title="查询结果" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
               url="${path }/user/roleList.htm" singleSelect="true" fit="true">
            <thead>
            <tr>
