...
/**
 * Created by wujianbin on 2014-06-17.
 */
public class ModifyExhibitorInfoRequest extends BaseRequest {
	...
	public ModifyExhibitorInfoRequest() {
		super();
	}
	...
	public String toString() {
		return "ModifyExhibitorInfoRequest{" +
				"einfoid=" + einfoid +
				", eid=" + eid +
