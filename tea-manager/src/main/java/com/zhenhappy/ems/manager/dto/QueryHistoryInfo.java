...
public class QueryHistoryInfo extends EasyuiRequest {
	...
	public QueryHistoryInfo(Integer id, String booth_number, String company_zh, String company_en, String telphone, String fax, String email,
							String website, String address_zh, String address_en, String zipcode, String product_type, String main_product_zh,
							String main_product_en, String company_profile, String invoice_head, String local_tax, String joiner_name,
							String joiner_telphone, String joiner_email, String fair_year, String field_back1, String field_back2,
							String field_back3, String field_back4) {
		this.id = id;
